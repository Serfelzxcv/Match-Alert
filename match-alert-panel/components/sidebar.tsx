...
import { Activity, BellRing, LayoutDashboard, LogOut, Settings } from "lucide-react";
...
const navItems = [
  ...
  { href: "/activity" as const, label: "Alertas", icon: Activity },
  { href: "/settings" as const, label: "Reglas", icon: Settings },
];
