...
const filters = [
  { value: "all", label: "Todo", color: null },
  { value: "answered", label: "Goles", color: "bg-type-answered" },
  { value: "routed", label: "Alertas", color: "bg-type-routed" },
  { value: "welcomed", label: "En vivo", color: "bg-type-welcomed" },
  { value: "surfaced", label: "Oportunidades", color: "bg-type-surfaced" },
  { value: "flagged", label: "Riesgos", color: "bg-type-flagged" },
] as const;
