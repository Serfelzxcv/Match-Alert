...
export default function ConversationPage({
  ...
  return (
    <>
      <Header description="Detalle de la regla y respuesta generada" title="Detalle de alerta" />
      <div className="flex-1 space-y-4 p-4">
        <BackButton fallbackHref="/activity">Alertas</BackButton>
        <Suspense
          fallback={
            <ViewTransition>
      ...
      <Card>
        <CardContent className="flex items-center justify-center gap-2.5 py-6 text-muted-foreground">
          ...
          <span className="text-sm">
            Los detalles privados solo son visibles para administradores.
          </span>
        </CardContent>
      </Card>
    );
      ...
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <h3 className="mt-3 font-medium text-base">
            Sin detalle de conversacion
          </h3>
          <p className="mt-1 text-muted-foreground text-sm">
            Este evento se registro sin hilo de conversacion.
          </p>
        </CardContent>
      </Card>
    );
